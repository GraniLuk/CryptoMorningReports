...
from shared_code.price_checker import fetch_daily_candles, fetch_hourly_candles, fetch_fifteen_min_candles
...
def test_daily_batch_direct():
    ...
    if candles:
        ...
        print(f"  Sample: O={candles[0].open}, H={candles[0].high}, "
...
def test_performance_comparison():
    ...
    api_reduction = ((estimated_api_calls - 1) / estimated_api_calls * 100) if estimated_api_calls > 0 else 0
