...
def test_hourly_candles_both_sources():
    ...
    if binance_symbol:
        ...
        if candles and len(candles) > 0:
            print(f"✅ BINANCE: Fetched {len(candles)} hourly candles for {binance_symbol.symbol_name}")
            results.append(True)
        else:
    ...
    if kucoin_symbol:
        ...
        if candles and len(candles) > 0:
            print(f"✅ KUCOIN: Fetched {len(candles)} hourly candles for {kucoin_symbol.symbol_name}")
            results.append(True)
        else:
...
def test_fifteen_min_candles_both_sources():
    ...
    if binance_symbol:
        ...
        if candles and len(candles) > 0:
            print(f"✅ BINANCE: Fetched {len(candles)} 15-min candles for {binance_symbol.symbol_name}")
            results.append(True)
        else:
    ...
    if kucoin_symbol:
        ...
        if candles and len(candles) > 0:
            print(f"✅ KUCOIN: Fetched {len(candles)} 15-min candles for {kucoin_symbol.symbol_name}")
            results.append(True)
        else:
...
def test_timezone_handling():
    ...
    if datetime_candles and all(c.end_date.tzinfo is not None for c in datetime_candles):
        print(f"✅ Daily candles: {len(datetime_candles)}/{len(daily_candles)} have timezone-aware datetime (newly fetched)")
        results.append(True)
    else:
    ...
    if datetime_candles and all(c.end_date.tzinfo is not None for c in datetime_candles):
        print(f"✅ Hourly candles: {len(datetime_candles)}/{len(hourly_candles)} have timezone-aware datetime")
        results.append(True)
    else:
    ...
    if datetime_candles and all(c.end_date.tzinfo is not None for c in datetime_candles):
        print(f"✅ 15-min candles: {len(datetime_candles)}/{len(fifteen_min_candles)} have timezone-aware datetime")
        results.append(True)
    else:
