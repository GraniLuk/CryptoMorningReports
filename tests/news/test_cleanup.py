...
def test_cleanup_and_statistics() -> None:
    ...
    # Set environment variable to use test cache directory
    original_cache_root = os.environ.get("ARTICLE_CACHE_ROOT")
    os.environ["ARTICLE_CACHE_ROOT"] = str(test_cache_root)
    ...
    try:
        ...
        if original_cache_root is not None:
            os.environ["ARTICLE_CACHE_ROOT"] = original_cache_root
        elif "ARTICLE_CACHE_ROOT" in os.environ:
