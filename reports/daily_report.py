...
from sharedCode.telegram import send_telegram_message, try_send_report_with_HTML_or_Markdown
...
async def process_daily_report(conn, telegram_enabled, telegram_token, telegram_chat_id):
    ...
    await send_telegram_message(telegram_enabled, telegram_token, telegram_chat_id, message_part2, parse_mode="HTML")
    await send_telegram_message(telegram_enabled, telegram_token, telegram_chat_id, stepn_report, parse_mode="HTML")
    await send_telegram_message(telegram_enabled, telegram_token, telegram_chat_id, volume_report, parse_mode="HTML")
